...
function Hero() {
    return (
        <div className="w-full min-h-screen bg-zinc-200 flex flex-col justify-between">
            ...
            <div className="flex flex-col m-auto justify-center bg-zinc-200 shadow-xl border border-slate-300 rounded-xl items-center md:min-w-[760px] bottom-[5%]">
                <p className="font-bold">Data services</p>
                <div className="flex flex-wrap justify-normal md:justify-between">
